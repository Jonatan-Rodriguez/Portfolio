      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-paper/60 dark:text-ink/60 mt-0.5">{item.type}</p>

            {item.detail && <p className="text-sm text-paper/80 dark:text-ink/80 mt-4 max-w-2xl">{item.detail}</p>}
